---
page_id: 'concept:intermediate-representation-ir'
kind: concept
cssclasses:
  - swarmvault
  - sv-concept
...
A standardized format (like LLVM IR) used to allow multiple frontends (languages) and backends (platforms) to connect to one common core, solving the 'N times M' problem in compilation.
