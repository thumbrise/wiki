---
page_id: 'concept:opinion-vs-fact'
kind: concept
cssclasses:
  - swarmvault
  - sv-concept
...
updated_at: '2026-05-03T04:02:08.752Z'
compiled_from:
  - 11-from-silicon-to-struct-283a2ad1
managed_by: system
backlinks:
...
Distinguishing between a required physical fact (like a boolean state) and a language or framework-specific convention (like how a language represents an enum).
