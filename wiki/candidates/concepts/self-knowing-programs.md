---
page_id: 'concept:self-knowing-programs'
kind: concept
cssclasses:
  - swarmvault
  - sv-concept
title: Self-knowing programs
...
---
# Self-knowing programs

## Summary

The future ideal state where a program is born knowing its own operations from the inside, eliminating the need for external parsing or reflection.
