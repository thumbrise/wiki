---
page_id: 'concept:semantic-path-rail'
kind: concept
cssclasses:
  - swarmvault
  - sv-concept
title: Semantic Path (Rail)
...
A directional flow (Input Rail, Output Rail, Error Rail) that carries results. 'Rail' describes the direction of the result, independent of HTTP or functional return types.
