...
A component that reconstructs a formal 'instruction' or 'operation' by analyzing existing, unstructured code (the 'archaeologist' role), turning existing code into the source of truth.
