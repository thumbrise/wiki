---
page_id: 'module:appbootloader-6dae842d'
kind: module
cssclasses:
  - swarmvault
  - sv-module
title: AppBootloader module
...
project_ids: []
node_ids:
  - 'module:appbootloader-6dae842d'
  - 'symbol:appbootloader-6dae842d:appbootloader.class'
freshness: fresh
status: active
confidence: 1
...
source_hashes:
  appbootloader-6dae842d: 6dae842d23abbd75d1be1d41b58e6b1ed6e79b26fb110b38f209dbe85095d72e
...
language: php
---
# AppBootloader module

Source ID: `appbootloader-6dae842d`
Source Path: `/Users/rk/GolandProjects/op/poc/spiral-emit/app/src/Application/Bootloader/AppBootloader.php`
Repo Path: `poc/spiral-emit/app/src/Application/Bootloader/AppBootloader.php`
Source Class: `first_party`
Language: `php`
Module Name: `poc/spiral-emit/app/src/Application/Bootloader/AppBootloader`
Namespace/Package: `App\Application\Bootloader`
Source Page: [[sources/appbootloader-6dae842d|AppBootloader]]

## Summary

AppBootloader is a php module, defining 1 top-level symbol(s), exporting 1 symbol(s), depending on 4 external package import(s).

## Imports

- imports `Spiral\Bootloader\DomainBootloader`
- imports `Spiral\Cycle\Interceptor\CycleInterceptor`
- imports `Spiral\Domain\GuardInterceptor`
- imports `Spiral\Interceptors\HandlerInterface`
...
- `AppBootloader` (class, exported): final class AppBootloader extends DomainBootloader { protected const SINGLETONS = [HandlerInterface::class => [self::class, 'domainCore']]; protected const INTERCEPTORS = [ Cycl...

## External Dependencies

- `Spiral\Bootloader\DomainBootloader`
- `Spiral\Cycle\Interceptor\CycleInterceptor`
- `Spiral\Domain\GuardInterceptor`
- `Spiral\Interceptors\HandlerInterface`
...
- `AppBootloader` extends `extends DomainBootloader`
