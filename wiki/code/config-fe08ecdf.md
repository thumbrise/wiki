---
page_id: 'module:config-fe08ecdf'
kind: module
cssclasses:
  - swarmvault
  - sv-module
...
project_ids: []
node_ids:
  - 'module:config-fe08ecdf'
freshness: fresh
status: active
confidence: 1
created_at: '2026-05-03T05:11:46.012Z'
updated_at: '2026-05-03T05:32:23.197Z'
compiled_from:
  - config-fe08ecdf
managed_by: system
backlinks:
...
source_hashes:
  config-fe08ecdf: fe08ecdfc379c42bfa186cc14ccf1b0b01ed000001ce87a3050633eabe90acf0
...
Source ID: `config-fe08ecdf`
Source Path: `/Users/rk/GolandProjects/op/docs/.vitepress/config.ts`
Repo Path: `docs/.vitepress/config.ts`
Source Class: `first_party`
Language: `typescript`
Module Name: `docs/.vitepress/config`
Source Page: [[sources/config-fe08ecdf|config]]
...
- imports `vitepress` (named `defineConfig`)
- imports `vitepress-plugin-mermaid` (named `withMermaid`)
- imports `vite-plugin-static-copy` (named `viteStaticCopy`)
