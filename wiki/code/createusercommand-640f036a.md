---
page_id: 'module:createusercommand-640f036a'
kind: module
cssclasses:
  - swarmvault
  - sv-module
title: CreateUserCommand module
...
project_ids: []
node_ids:
  - 'module:createusercommand-640f036a'
  - 'symbol:createusercommand-640f036a:createusercommand.class'
freshness: fresh
status: active
confidence: 1
created_at: '2026-05-03T05:11:46.012Z'
updated_at: '2026-05-03T05:32:23.204Z'
compiled_from:
  - createusercommand-640f036a
managed_by: system
backlinks:
  - 'source:createusercommand-640f036a'
  - 'module:createuserservice-da5191cb'
  - 'output:source-briefs/directory-op-597d97ce'
schema_hash: 874431dbbfdec0b254a4aa1bf002900574c9b485735a883690c2becb5f717720
source_hashes:
  createusercommand-640f036a: 640f036a4e442ba5e516490245bc002ec50112d18ad09a91f7a2fccb877121cc
...
language: php
---
# CreateUserCommand module

Source ID: `createusercommand-640f036a`
Source Path: `/Users/rk/GolandProjects/op/poc/spiral-emit/app/src/Endpoint/Console/CreateUserCommand.php`
Repo Path: `poc/spiral-emit/app/src/Endpoint/Console/CreateUserCommand.php`
Source Class: `first_party`
Language: `php`
Module Name: `poc/spiral-emit/app/src/Endpoint/Console/CreateUserCommand`
Namespace/Package: `App\Endpoint\Console`
Source Page: [[sources/createusercommand-640f036a|CreateUserCommand]]

## Summary

CreateUserCommand is a php module, defining 1 top-level symbol(s), exporting 1 symbol(s), depending on 5 external package import(s).

## Imports

- imports [[code/createuserservice-da5191cb|CreateUserService module]]
- imports `Spiral\Console\Attribute\Argument`
- imports `Spiral\Console\Attribute\AsCommand`
- imports `Spiral\Console\Attribute\Question`
- imports `Spiral\Console\Command`
...
- `CreateUserCommand` (class, exported): #[AsCommand(name: 'create:user', description: 'Create a new user')] final class CreateUserCommand extends Command { #[Argument(description: 'User name')] #[Question(question: 'P...

## External Dependencies

- `Spiral\Console\Attribute\Argument`
- `Spiral\Console\Attribute\AsCommand`
- `Spiral\Console\Attribute\Question`
- `Spiral\Console\Command`
...
- `CreateUserCommand` extends `extends Command`
