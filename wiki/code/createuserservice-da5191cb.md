---
page_id: 'module:createuserservice-da5191cb'
kind: module
cssclasses:
  - swarmvault
  - sv-module
title: CreateUserService module
...
node_ids:
  ...
  - 'symbol:createuserservice-da5191cb:createuserservice.class'
freshness: fresh
status: active
confidence: 1
created_at: '2026-05-03T05:11:46.012Z'
updated_at: '2026-05-03T05:32:23.205Z'
compiled_from:
  - createuserservice-da5191cb
managed_by: system
backlinks:
...
source_hashes:
  createuserservice-da5191cb: da5191cbf0895ed29b9fd484f3de39cd88cb2bec58390a1fe59ef34f8561deec
...
language: php
---
# CreateUserService module

Source ID: `createuserservice-da5191cb`
Source Path: `/Users/rk/GolandProjects/op/poc/spiral-emit/app/src/Domain/User/Service/CreateUserService.php`
Repo Path: `poc/spiral-emit/app/src/Domain/User/Service/CreateUserService.php`
Source Class: `first_party`
Language: `php`
Module Name: `poc/spiral-emit/app/src/Domain/User/Service/CreateUserService`
Namespace/Package: `App\Domain\User\Service`
Source Page: [[sources/createuserservice-da5191cb|CreateUserService]]

## Summary

CreateUserService is a php module, defining 1 top-level symbol(s), exporting 1 symbol(s), depending on 2 external package import(s).

## Imports

- imports `Cycle\ORM\EntityManagerInterface`
...
- `CreateUserService` (class, exported): final class CreateUserService { public function __construct( private readonly EntityManagerInterface $em, ) {} public function create(string $username, string $email): User { $u...
