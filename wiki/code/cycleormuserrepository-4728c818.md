---
page_id: 'module:cycleormuserrepository-4728c818'
kind: module
cssclasses:
  - swarmvault
  - sv-module
title: CycleORMUserRepository module
...
project_ids: []
node_ids:
  - 'module:cycleormuserrepository-4728c818'
  - 'symbol:cycleormuserrepository-4728c818:cycleormuserrepository.class'
freshness: fresh
status: active
confidence: 1
created_at: '2026-05-03T05:11:46.013Z'
updated_at: '2026-05-03T05:32:23.206Z'
compiled_from:
  - cycleormuserrepository-4728c818
managed_by: system
backlinks:
  - 'source:cycleormuserrepository-4728c818'
  - 'module:user-d5b6c9e9'
  - 'module:usernotfoundexception-204c3d22'
  - 'module:userrepositoryinterface-4c171a4e'
  - 'output:source-briefs/directory-op-597d97ce'
schema_hash: 874431dbbfdec0b254a4aa1bf002900574c9b485735a883690c2becb5f717720
source_hashes:
  cycleormuserrepository-4728c818: 4728c818783565ceca31e4f5606aa80e7b5e4ee84dced103c4f0a7e2f1934e96
...
language: php
---
# CycleORMUserRepository module

Source ID: `cycleormuserrepository-4728c818`
Source Path: `/Users/rk/GolandProjects/op/poc/spiral-emit/app/src/Infrastructure/Persistence/CycleORMUserRepository.php`
Repo Path: `poc/spiral-emit/app/src/Infrastructure/Persistence/CycleORMUserRepository.php`
Source Class: `first_party`
Language: `php`
Module Name: `poc/spiral-emit/app/src/Infrastructure/Persistence/CycleORMUserRepository`
Namespace/Package: `App\Infrastructure\Persistence`
Source Page: [[sources/cycleormuserrepository-4728c818|CycleORMUserRepository]]

## Summary

CycleORMUserRepository is a php module, defining 1 top-level symbol(s), exporting 1 symbol(s), depending on 4 external package import(s).

## Imports

- imports `Cycle\ORM\Select\Repository`
- imports [[code/user-d5b6c9e9|User module]]
- imports [[code/usernotfoundexception-204c3d22|UserNotFoundException module]]
- imports [[code/userrepositoryinterface-4c171a4e|UserRepositoryInterface module]]

## Exports

- `CycleORMUserRepository`

## Symbols

- `CycleORMUserRepository` (class, exported): final class CycleORMUserRepository extends Repository implements UserRepositoryInterface { #[\Override] public function getById(int $id): User { $user = $this->findByPK($id); if...

## External Dependencies

- `Cycle\ORM\Select\Repository`
...
- `CycleORMUserRepository` extends `extends Repository`
- `CycleORMUserRepository` implements `implements UserRepositoryInterface`
