---
page_id: 'module:demotest-276ee805'
kind: module
cssclasses:
  - swarmvault
  - sv-module
title: DemoTest module
...
project_ids: []
node_ids:
  - 'module:demotest-276ee805'
  - 'symbol:demotest-276ee805:demotest.class'
freshness: fresh
status: active
confidence: 1
created_at: '2026-05-03T05:11:46.017Z'
...
source_hashes:
  demotest-276ee805: 276ee805c23400685505e7320874f375392a5247047aca80900385f7632e416e
...
Source ID: `demotest-276ee805`
Source Path: `/Users/rk/GolandProjects/op/poc/spiral-emit/tests/Unit/DemoTest.php`
Repo Path: `poc/spiral-emit/tests/Unit/DemoTest.php`
Source Class: `first_party`
Language: `php`
Module Name: `poc/spiral-emit/tests/Unit/DemoTest`
Namespace/Package: `Tests\Unit`
Source Page: [[sources/demotest-276ee805|DemoTest]]

## Summary

DemoTest is a php module, defining 1 top-level symbol(s), exporting 1 symbol(s), depending on 1 external package import(s).
...
- `DemoTest` (class, exported): class DemoTest extends TestCase { public function testDemo(): void { $expected = true; $actual = false; $this->assertTrue($expected); $this->assertFalse($actual); } }
...
- `DemoTest` extends `extends TestCase`
