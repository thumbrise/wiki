---
page_id: 'module:donothing-0c30237f'
kind: module
cssclasses:
  - swarmvault
  - sv-module
title: DoNothing module
...
project_ids: []
node_ids:
  - 'module:donothing-0c30237f'
  - 'symbol:donothing-0c30237f:donothing.class'
freshness: fresh
status: active
confidence: 1
...
source_hashes:
  donothing-0c30237f: 0c30237ff987a78afd0f43b5ea5b555a0f7c2fdba72c6dd8d511fadfd03e392c
...
Source ID: `donothing-0c30237f`
Source Path: `/Users/rk/GolandProjects/op/poc/spiral-emit/app/src/Endpoint/Console/DoNothing.php`
Repo Path: `poc/spiral-emit/app/src/Endpoint/Console/DoNothing.php`
Source Class: `first_party`
Language: `php`
Module Name: `poc/spiral-emit/app/src/Endpoint/Console/DoNothing`
Namespace/Package: `App\Endpoint\Console`
Source Page: [[sources/donothing-0c30237f|DoNothing]]

## Summary

DoNothing is a php module, defining 1 top-level symbol(s), exporting 1 symbol(s), depending on 6 external package import(s).

## Imports

- imports `Spiral\Console\Attribute\Argument`
- imports `Spiral\Console\Attribute\AsCommand`
- imports `Spiral\Console\Attribute\Option`
- imports `Spiral\Console\Attribute\Question`
- imports `Spiral\Console\Command`
- imports `Symfony\Component\Console\Input\InputOption`
...
- `DoNothing` (class, exported): #[AsCommand(name: 'do-nothing', description: 'The command does nothing.')] final class DoNothing extends Command { #[Argument(description: 'Task name')] #[Question(question: 'Pr...
...
- `DoNothing` extends `extends Command`
