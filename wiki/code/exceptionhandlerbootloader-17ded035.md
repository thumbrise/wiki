---
page_id: 'module:exceptionhandlerbootloader-17ded035'
kind: module
cssclasses:
  - swarmvault
  - sv-module
title: ExceptionHandlerBootloader module
...
project_ids: []
node_ids:
  - 'module:exceptionhandlerbootloader-17ded035'
  - 'symbol:exceptionhandlerbootloader-17ded035:exceptionhandlerbootloader.class'
freshness: fresh
status: active
confidence: 1
created_at: '2026-05-03T05:11:46.022Z'
updated_at: '2026-05-03T05:32:23.224Z'
compiled_from:
  - exceptionhandlerbootloader-17ded035
managed_by: system
backlinks:
  - 'source:exceptionhandlerbootloader-17ded035'
  - 'module:viewrenderer-4600606b'
  - 'output:source-briefs/directory-op-597d97ce'
schema_hash: 874431dbbfdec0b254a4aa1bf002900574c9b485735a883690c2becb5f717720
source_hashes:
  exceptionhandlerbootloader-17ded035: 17ded035a34d660f7ac10a73712b0b07274e2cec3a04ec4eb159b19ca6dbc1c5
...
language: php
---
# ExceptionHandlerBootloader module

Source ID: `exceptionhandlerbootloader-17ded035`
Source Path: `/Users/rk/GolandProjects/op/poc/spiral-emit/app/src/Application/Bootloader/ExceptionHandlerBootloader.php`
Repo Path: `poc/spiral-emit/app/src/Application/Bootloader/ExceptionHandlerBootloader.php`
Source Class: `first_party`
Language: `php`
Module Name: `poc/spiral-emit/app/src/Application/Bootloader/ExceptionHandlerBootloader`
Namespace/Package: `App\Application\Bootloader`
Source Page: [[sources/exceptionhandlerbootloader-17ded035|ExceptionHandlerBootloader]]

## Summary

ExceptionHandlerBootloader is a php module, defining 1 top-level symbol(s), exporting 1 symbol(s), depending on 13 external package import(s).

## Imports

- imports [[code/viewrenderer-4600606b|ViewRenderer module]]
- imports `Spiral\Boot\AbstractKernel`
- imports `Spiral\Boot\Bootloader\Bootloader`
- imports `Spiral\Boot\Environment\AppEnvironment`
- imports `Spiral\Exceptions\ExceptionHandler`
- imports `Spiral\Exceptions\Renderer\ConsoleRenderer`
- imports `Spiral\Exceptions\Renderer\JsonRenderer`
- imports `Spiral\Exceptions\Reporter\FileReporter`
- imports `Spiral\Exceptions\Reporter\LoggerReporter`
- imports `Spiral\Http\ErrorHandler\PlainRenderer`
- imports `Spiral\Http\ErrorHandler\RendererInterface`
- imports `Spiral\Http\Middleware\ErrorHandlerMiddleware\EnvSuppressErrors`
- imports `Spiral\Http\Middleware\ErrorHandlerMiddleware\SuppressErrorsInterface`
...
- `ExceptionHandlerBootloader` (class, exported): final class ExceptionHandlerBootloader extends Bootloader { protected const BINDINGS = [ SuppressErrorsInterface::class => EnvSuppressErrors::class, RendererInterface::class => ...

## External Dependencies

- `Spiral\Boot\AbstractKernel`
- `Spiral\Boot\Bootloader\Bootloader`
- `Spiral\Boot\Environment\AppEnvironment`
- `Spiral\Exceptions\ExceptionHandler`
- `Spiral\Exceptions\Renderer\ConsoleRenderer`
- `Spiral\Exceptions\Renderer\JsonRenderer`
- `Spiral\Exceptions\Reporter\FileReporter`
- `Spiral\Exceptions\Reporter\LoggerReporter`
- `Spiral\Http\ErrorHandler\PlainRenderer`
- `Spiral\Http\ErrorHandler\RendererInterface`
- `Spiral\Http\Middleware\ErrorHandlerMiddleware\EnvSuppressErrors`
- `Spiral\Http\Middleware\ErrorHandlerMiddleware\SuppressErrorsInterface`
...
- `ExceptionHandlerBootloader` extends `extends Bootloader`
