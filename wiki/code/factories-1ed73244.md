---
page_id: 'module:factories-1ed73244'
kind: module
cssclasses:
  - swarmvault
  - sv-module
title: factories module
...
project_ids: []
node_ids:
  - 'module:factories-1ed73244'
  - 'symbol:factories-1ed73244:emptyoperation.function'
  - 'symbol:factories-1ed73244:createinstruction.function'
freshness: fresh
status: active
confidence: 1
...
source_hashes:
  factories-1ed73244: 1ed73244a3132d4a0442fcd5a945a554c0e5adb4b1d9c8fef4dbb8d6ee724ae9
...
Source ID: `factories-1ed73244`
Source Path: `/Users/rk/GolandProjects/op/docs/.vitepress/packages/op-sdk/src/factories.ts`
Repo Path: `docs/.vitepress/packages/op-sdk/src/factories.ts`
Source Class: `first_party`
Language: `typescript`
Module Name: `docs/.vitepress/packages/op-sdk/src/factories`
Source Page: [[sources/factories-1ed73244|factories]]

## Summary

factories is a typescript module, defining 2 top-level symbol(s), exporting 2 symbol(s), importing 1 local module(s).

## Imports

- imports `./types` (named `Instruction`, `Operation`, `Term`)
...
- `createInstruction` (function, exported): export function createInstruction( id: string, comment: string, version: string = '1.0.0', operations: Operation[] = [], traits: Term[] = [] ): Instruction
