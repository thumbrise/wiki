---
page_id: 'module:handler-27c7389d'
kind: module
cssclasses:
  - swarmvault
  - sv-module
...
project_ids: []
node_ids:
  - 'module:handler-27c7389d'
  - 'symbol:handler-27c7389d:handler.class'
freshness: fresh
status: active
confidence: 1
created_at: '2026-05-03T05:11:46.029Z'
updated_at: '2026-05-03T05:32:23.233Z'
compiled_from:
  - handler-27c7389d
managed_by: system
backlinks:
...
source_hashes:
  handler-27c7389d: 27c7389dd99f32d65acf072f2cfa5426fa5a07a82c297dced790b30206d20274
...
Source ID: `handler-27c7389d`
Source Path: `/Users/rk/GolandProjects/op/poc/spiral-emit/app/src/Application/Exception/Handler.php`
Repo Path: `poc/spiral-emit/app/src/Application/Exception/Handler.php`
Source Class: `first_party`
Language: `php`
Module Name: `poc/spiral-emit/app/src/Application/Exception/Handler`
Namespace/Package: `App\Application\Exception`
Source Page: [[sources/handler-27c7389d|Handler]]

## Summary

Handler is a php module, defining 1 top-level symbol(s), exporting 1 symbol(s), depending on 1 external package import(s).
...
- `Handler` (class, exported): final class Handler extends ExceptionHandler { #[\Override] protected function bootBasicHandlers(): void { parent::bootBasicHandlers(); // $this->addRenderer(new CustomRenderer(...
...
- `Handler` extends `extends ExceptionHandler`
