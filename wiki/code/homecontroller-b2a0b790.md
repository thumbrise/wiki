---
page_id: 'module:homecontroller-b2a0b790'
kind: module
cssclasses:
  - swarmvault
  - sv-module
title: HomeController module
...
project_ids: []
node_ids:
  - 'module:homecontroller-b2a0b790'
  - 'symbol:homecontroller-b2a0b790:homecontroller.class'
freshness: fresh
status: active
confidence: 1
created_at: '2026-05-03T05:11:46.029Z'
updated_at: '2026-05-03T05:32:23.234Z'
compiled_from:
  - homecontroller-b2a0b790
managed_by: system
backlinks:
...
source_hashes:
  homecontroller-b2a0b790: b2a0b790bbcfdfc006820888935cf482f2116f8239d901dfccf17f2c0b93d665
...
Source ID: `homecontroller-b2a0b790`
Source Path: `/Users/rk/GolandProjects/op/poc/spiral-emit/app/src/Endpoint/Web/HomeController.php`
Repo Path: `poc/spiral-emit/app/src/Endpoint/Web/HomeController.php`
Source Class: `first_party`
Language: `php`
Module Name: `poc/spiral-emit/app/src/Endpoint/Web/HomeController`
Namespace/Package: `App\Endpoint\Web`
Source Page: [[sources/homecontroller-b2a0b790|HomeController]]

## Summary

HomeController is a php module, defining 1 top-level symbol(s), exporting 1 symbol(s), depending on 3 external package import(s).

## Imports

- imports `Exception`
- imports `Spiral\Prototype\Traits\PrototypeTrait`
- imports `Spiral\Router\Annotation\Route`
...
- `HomeController` (class, exported): final class HomeController { /** * Read more about Prototyping: * @link https://spiral.dev/docs/basics-prototype/#installation */ use PrototypeTrait; #[Route(route: '/', name: '...
