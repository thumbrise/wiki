---
page_id: 'module:homecontrollertest-9feb0ff5'
kind: module
cssclasses:
  - swarmvault
  - sv-module
title: HomeControllerTest module
...
project_ids: []
node_ids:
  - 'module:homecontrollertest-9feb0ff5'
  - 'symbol:homecontrollertest-9feb0ff5:homecontrollertest.class'
freshness: fresh
status: active
confidence: 1
created_at: '2026-05-03T05:11:46.029Z'
updated_at: '2026-05-03T05:32:23.235Z'
compiled_from:
  - homecontrollertest-9feb0ff5
managed_by: system
backlinks:
  - 'source:homecontrollertest-9feb0ff5'
  - 'module:testcase-e8b69b5c'
  - 'output:source-briefs/directory-op-597d97ce'
schema_hash: 874431dbbfdec0b254a4aa1bf002900574c9b485735a883690c2becb5f717720
source_hashes:
  homecontrollertest-9feb0ff5: 9feb0ff5656559bddeadc0981bbb48fcb90701cf490473b6bb505830d23fbce9
...
language: php
---
# HomeControllerTest module

Source ID: `homecontrollertest-9feb0ff5`
Source Path: `/Users/rk/GolandProjects/op/poc/spiral-emit/tests/Feature/Controller/HomeControllerTest.php`
Repo Path: `poc/spiral-emit/tests/Feature/Controller/HomeControllerTest.php`
Source Class: `first_party`
Language: `php`
Module Name: `poc/spiral-emit/tests/Feature/Controller/HomeControllerTest`
Namespace/Package: `Tests\Feature\Controller`
Source Page: [[sources/homecontrollertest-9feb0ff5|HomeControllerTest]]

## Summary

HomeControllerTest is a php module, defining 1 top-level symbol(s), exporting 1 symbol(s), depending on 3 external package import(s).

## Imports

- imports `Spiral\Bootloader\I18nBootloader`
- imports [[code/testcase-e8b69b5c|TestCase module]]
- imports `Spiral\Testing\Http\FakeHttp`
...
- `HomeControllerTest` (class, exported): class HomeControllerTest extends TestCase { private FakeHttp $http; public function testDefaultActionWorks(): void { $response = $this->http->get('/')->assertOk(); $this->assert...

## External Dependencies

- `Spiral\Bootloader\I18nBootloader`
- `Spiral\Testing\Http\FakeHttp`
...
- `HomeControllerTest` extends `extends TestCase`
