...
updated_at: '2026-05-03T04:02:08.725Z'
compiled_from:
  - index-e404d6cb
managed_by: system
backlinks:
...
source_hashes:
  index-e404d6cb: e404d6cbf866b28a4ee8fb6e8fae9297549685d8b9e3c0503471897b64fb590d
...
Source ID: `index-e404d6cb`
Source Path: `/Users/rk/GolandProjects/wiki/state/sources/github_repo-thumbrise-op-a16ed6ba/checkout/docs/.vitepress/theme/index.ts`
Repo Path: `docs/.vitepress/theme/index.ts`
Source Class: `first_party`
Language: `typescript`
Module Name: `docs/.vitepress/theme`
Source Page: [[sources/index-e404d6cb|index]]

## Summary

index is a typescript module, defining 0 top-level symbol(s), exporting 0 symbol(s), importing 5 local module(s), depending on 1 external package import(s).

## Imports

- imports `vitepress/theme` (default `DefaultTheme`)
- imports [[code/mermaid-fix-e2dd139e|mermaid-fix module]]
- imports [[code/playground-e45a65a6|Playground module]] (default `Playground`)
- imports [[code/termeditor-e3bdad59|TermEditor module]] (default `TermEditor`)
- imports [[code/termviz-37c301d3|TermViz module]] (default `TermViz`)
- imports [[code/scitooltip-2260fcf0|SciTooltip module]] (default `SciTooltip`)
