---
page_id: 'module:jsonc-parser-d0f45765'
kind: module
cssclasses:
  - swarmvault
  - sv-module
title: jsonc-parser module
...
status: active
confidence: 1
created_at: '2026-05-03T05:11:46.036Z'
updated_at: '2026-05-03T05:32:23.240Z'
compiled_from:
  - jsonc-parser-d0f45765
managed_by: system
backlinks:
...
source_hashes:
  jsonc-parser-d0f45765: d0f45765495e1675eb9f01190b3416b0b8bf1e542ec9708ee8894c9e0e0dbc46
...
Source ID: `jsonc-parser-d0f45765`
Source Path: `/Users/rk/GolandProjects/op/docs/.vitepress/cache/deps/jsonc-parser.js`
Repo Path: `docs/.vitepress/cache/deps/jsonc-parser.js`
Source Class: `first_party`
Language: `javascript`
Module Name: `docs/.vitepress/cache/deps/jsonc-parser`
Source Page: [[sources/jsonc-parser-d0f45765|jsonc-parser]]

## Summary

jsonc-parser is a javascript module, defining 46 top-level symbol(s), exporting 0 symbol(s), importing 1 local module(s).
...
- `createScanner` (function): function createScanner(text, ignoreTrivia = false)
- `isWhiteSpace` (function): function isWhiteSpace(ch)
- `isLineBreak` (function): function isLineBreak(ch)
- `isDigit` (function): function isDigit(ch)
- `CharacterCodes` (variable): var CharacterCodes;
- `cachedSpaces` (variable): var cachedSpaces = new Array(20).fill(0).map((_, index) => { return " ".repeat(index); });
- `maxCachedValues` (variable): var maxCachedValues = 200;
- `cachedBreakLinesWithSpaces` (variable): var cachedBreakLinesWithSpaces = { " ": { "\n": new Array(maxCachedValues).fill(0).map((_, index) => { return "\n" + " ".repeat(index); }), "\r": new Array(maxCachedValues).fill...
- `supportedEols` (variable): var supportedEols = ["\n", "\r", "\r\n"];
- `format` (function): function format(documentText, range, options)
- `repeat` (function): function repeat(s, count)
- `computeIndentLevel` (function): function computeIndentLevel(content, options)
- `getEOL` (function): function getEOL(options, text)
- `isEOL` (function): function isEOL(text, offset)
- `ParseOptions` (variable): var ParseOptions;
- `getLocation` (function): function getLocation(text, position)
- `parse` (function): function parse(text, errors = [], options = ParseOptions.DEFAULT)
- `parseTree` (function): function parseTree(text, errors = [], options = ParseOptions.DEFAULT)
- `findNodeAtLocation` (function): function findNodeAtLocation(root, path)
- `getNodePath` (function): function getNodePath(node)
- `getNodeValue` (function): function getNodeValue(node)
- `contains` (function): function contains(node, offset, includeRightBound = false)
- `findNodeAtOffset` (function): function findNodeAtOffset(node, offset, includeRightBound = false)
- `visit` (function): function visit(text, visitor, options = ParseOptions.DEFAULT)
- `stripComments` (function): function stripComments(text, replaceCh)
- `getNodeType` (function): function getNodeType(value)
- `setProperty` (function): function setProperty(text, originalPath, value, options)
- `withFormatting` (function): function withFormatting(text, edit, options)
- `applyEdit` (function): function applyEdit(text, edit)
- `createScanner2` (variable): var createScanner2 = createScanner;
- `ScanError` (variable): var ScanError;
- `SyntaxKind` (variable): var SyntaxKind;
- `getLocation2` (variable): var getLocation2 = getLocation;
- `parse2` (variable): var parse2 = parse;
- `parseTree2` (variable): var parseTree2 = parseTree;
- `findNodeAtLocation2` (variable): var findNodeAtLocation2 = findNodeAtLocation;
- `findNodeAtOffset2` (variable): var findNodeAtOffset2 = findNodeAtOffset;
- `getNodePath2` (variable): var getNodePath2 = getNodePath;
- `getNodeValue2` (variable): var getNodeValue2 = getNodeValue;
- `visit2` (variable): var visit2 = visit;
- `stripComments2` (variable): var stripComments2 = stripComments;
- `ParseErrorCode` (variable): var ParseErrorCode;
- `printParseErrorCode` (function): function printParseErrorCode(code)
- `format2` (function): function format2(documentText, range, options)
- `modify` (function): function modify(text, path, value, options)
- `applyEdits` (function): function applyEdits(text, edits)
...
- `createScanner` calls `isDigit`
- `createScanner` calls `isLineBreak`
- `createScanner` calls `isWhiteSpace`
- `format` calls `isEOL`
- `format` calls `computeIndentLevel`
- `format` calls `getEOL`
- `format` calls `repeat`
- `format` calls `createScanner`
- `getLocation` calls `visit`
- `getLocation` calls `getNodeType`
- `parse` calls `visit`
- `parseTree` calls `getNodeType`
- `parseTree` calls `visit`
- `findNodeAtOffset` calls `contains`
- `visit` calls `createScanner`
- `stripComments` calls `createScanner`
- `setProperty` calls `parseTree`
- `setProperty` calls `findNodeAtLocation`
- `setProperty` calls `withFormatting`
- `withFormatting` calls `applyEdit`
- `withFormatting` calls `isEOL`
- `withFormatting` calls `format`
- `format2` calls `format`
- `modify` calls `setProperty`
- `applyEdits` calls `applyEdit`
