---
page_id: 'module:kernel-a4634d28'
kind: module
cssclasses:
  - swarmvault
  - sv-module
...
project_ids: []
node_ids:
  - 'module:kernel-a4634d28'
  - 'symbol:kernel-a4634d28:kernel.class'
freshness: fresh
status: active
confidence: 1
created_at: '2026-05-03T05:11:46.039Z'
updated_at: '2026-05-03T05:32:23.243Z'
compiled_from:
  - kernel-a4634d28
managed_by: system
backlinks:
...
source_hashes:
  kernel-a4634d28: a4634d28b7ee7c1f45ed80fa04c638a2cad74c158bf5cff6ffe1100115503a73
...
Source ID: `kernel-a4634d28`
Source Path: `/Users/rk/GolandProjects/op/poc/spiral-emit/app/src/Application/Kernel.php`
Repo Path: `poc/spiral-emit/app/src/Application/Kernel.php`
Source Class: `first_party`
Language: `php`
Module Name: `poc/spiral-emit/app/src/Application/Kernel`
Namespace/Package: `App\Application`
Source Page: [[sources/kernel-a4634d28|Kernel]]

## Summary

Kernel is a php module, defining 1 top-level symbol(s), exporting 1 symbol(s), depending on 19 external package import(s).

## Imports

- imports `Spiral\Boot\Bootloader\CoreBootloader`
- imports `Spiral\Bootloader` (namespace `Framework`)
- imports `Spiral\Bootloader\Http\HttpBootloader`
- imports `Spiral\Bootloader\I18nBootloader`
- imports `Spiral\Bootloader\Views\TranslatedCacheBootloader`
- imports `Spiral\Cycle\Bootloader` (namespace `CycleBridge`)
- imports `Spiral\Debug\Bootloader\DumperBootloader`
- imports `Spiral\DotEnv\Bootloader\DotenvBootloader`
- imports `Spiral\Monolog\Bootloader\MonologBootloader`
- imports `Spiral\Nyholm\Bootloader\NyholmBootloader`
- imports `Spiral\Prototype\Bootloader\PrototypeBootloader`
- imports `Spiral\RoadRunnerBridge\Bootloader` (namespace `RoadRunnerBridge`)
- imports `Spiral\Scaffolder\Bootloader\ScaffolderBootloader`
- imports `Spiral\Stempler\Bootloader\StemplerBootloader`
- imports `Spiral\Tokenizer\Bootloader\TokenizerListenerBootloader`
- imports `Spiral\Validation\Bootloader\ValidationBootloader`
- imports `Spiral\Validator\Bootloader\ValidatorBootloader`
- imports `Spiral\Views\Bootloader\ViewsBootloader`
- imports `Spiral\YiiErrorHandler\Bootloader\YiiErrorHandlerBootloader`
...
- `Kernel` (class, exported): class Kernel extends \Spiral\Framework\Kernel { #[\Override] public function defineSystemBootloaders(): array { return [ CoreBootloader::class, DotenvBootloader::class, Tokenize...

## External Dependencies

- `Spiral\Boot\Bootloader\CoreBootloader`
- `Spiral\Bootloader`
- `Spiral\Bootloader\Http\HttpBootloader`
- `Spiral\Bootloader\I18nBootloader`
- `Spiral\Bootloader\Views\TranslatedCacheBootloader`
...
- `Spiral\Nyholm\Bootloader\NyholmBootloader`
- `Spiral\Prototype\Bootloader\PrototypeBootloader`
- `Spiral\RoadRunnerBridge\Bootloader`
- `Spiral\Scaffolder\Bootloader\ScaffolderBootloader`
- `Spiral\Stempler\Bootloader\StemplerBootloader`
- `Spiral\Tokenizer\Bootloader\TokenizerListenerBootloader`
