---
page_id: 'module:localeselector-a2212b51'
kind: module
cssclasses:
  - swarmvault
  - sv-module
title: LocaleSelector module
...
node_ids:
  ...
  - 'symbol:localeselector-a2212b51:localeselector.class'
freshness: fresh
status: active
confidence: 1
created_at: '2026-05-03T05:11:46.041Z'
updated_at: '2026-05-03T05:32:23.246Z'
compiled_from:
  - localeselector-a2212b51
managed_by: system
backlinks:
...
source_hashes:
  localeselector-a2212b51: a2212b51a538c5a56d7b450006061350a630c945063c1543a6c57112d54e9338
...
language: php
---
# LocaleSelector module

Source ID: `localeselector-a2212b51`
Source Path: `/Users/rk/GolandProjects/op/poc/spiral-emit/app/src/Endpoint/Web/Middleware/LocaleSelector.php`
Repo Path: `poc/spiral-emit/app/src/Endpoint/Web/Middleware/LocaleSelector.php`
Source Class: `first_party`
Language: `php`
Module Name: `poc/spiral-emit/app/src/Endpoint/Web/Middleware/LocaleSelector`
Namespace/Package: `App\Endpoint\Web\Middleware`
Source Page: [[sources/localeselector-a2212b51|LocaleSelector]]

## Summary

LocaleSelector is a php module, defining 1 top-level symbol(s), exporting 1 symbol(s), depending on 5 external package import(s).

## Imports

- imports `Psr\Http\Message\ResponseInterface`
- imports `Psr\Http\Message\ServerRequestInterface`
- imports `Psr\Http\Server\MiddlewareInterface`
- imports `Psr\Http\Server\RequestHandlerInterface`
- imports `Spiral\Translator\Translator`
...
- `LocaleSelector` (class, exported): final class LocaleSelector implements MiddlewareInterface { /** @var string[] */ private array $availableLocales; public function __construct( private readonly Translator $trans...
...
- `LocaleSelector` implements `implements MiddlewareInterface`
