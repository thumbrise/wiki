---
page_id: 'module:loggingbootloader-143850b0'
kind: module
cssclasses:
  - swarmvault
  - sv-module
title: LoggingBootloader module
...
project_ids: []
node_ids:
  - 'module:loggingbootloader-143850b0'
  - 'symbol:loggingbootloader-143850b0:loggingbootloader.class'
freshness: fresh
status: active
confidence: 1
created_at: '2026-05-03T05:11:46.041Z'
...
source_hashes:
  loggingbootloader-143850b0: 143850b0482b859ba01827d43faa007969f1655ae06e0a2ab491165970bedfea
...
language: php
---
# LoggingBootloader module

Source ID: `loggingbootloader-143850b0`
Source Path: `/Users/rk/GolandProjects/op/poc/spiral-emit/app/src/Application/Bootloader/LoggingBootloader.php`
Repo Path: `poc/spiral-emit/app/src/Application/Bootloader/LoggingBootloader.php`
Source Class: `first_party`
Language: `php`
Module Name: `poc/spiral-emit/app/src/Application/Bootloader/LoggingBootloader`
Namespace/Package: `App\Application\Bootloader`
Source Page: [[sources/loggingbootloader-143850b0|LoggingBootloader]]

## Summary

LoggingBootloader is a php module, defining 1 top-level symbol(s), exporting 1 symbol(s), depending on 6 external package import(s).

## Imports

- imports `Monolog\Level`
- imports `Spiral\Boot\Bootloader\Bootloader`
- imports `Spiral\Config\ConfiguratorInterface`
- imports `Spiral\Http\Middleware\ErrorHandlerMiddleware`
- imports `Spiral\Monolog\Bootloader\MonologBootloader`
- imports `Spiral\Monolog\Config\MonologConfig`
...
- `LoggingBootloader` (class, exported): final class LoggingBootloader extends Bootloader { public function __construct( private readonly ConfiguratorInterface $config, ) {} public function init(MonologBootloader $mono...

## External Dependencies

- `Monolog\Level`
- `Spiral\Boot\Bootloader\Bootloader`
- `Spiral\Config\ConfiguratorInterface`
- `Spiral\Http\Middleware\ErrorHandlerMiddleware`
- `Spiral\Monolog\Bootloader\MonologBootloader`
- `Spiral\Monolog\Config\MonologConfig`
...
- `LoggingBootloader` extends `extends Bootloader`
