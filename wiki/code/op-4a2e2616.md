...
Repo Path: `sdk/go/op.go`
Source Class: `first_party`
Language: `go`
Module Name: `sdk/go/op`
Namespace/Package: `op`
Source Page: [[sources/op-4a2e2616|op]]
...
- `Instruction` (struct, exported): Instruction struct { Version string `json:"version"` Operations []Operation `json:"operations"` }
- `Operation` (struct, exported): Operation struct { ID string `json:"id"` Comment string `json:"comment"` Input []Term `json:"input"` Output []Term `json:"output"` Error []Term `json:"error"` Trait []Term `json...
- `Term` (struct, exported): Term struct { ID string `json:"id"` Comment string `json:"comment,omitempty"` Required *bool `json:"required,omitempty"` Kind Kind `json:"kind,omitempty"` Value any `json:"value...
- `Kind` (type_alias, exported): Kind string
