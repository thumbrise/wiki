...
updated_at: '2026-05-03T05:32:23.253Z'
compiled_from:
  - op-6fb1bf01
managed_by: system
backlinks:
...
source_hashes:
  op-6fb1bf01: 6fb1bf01e4202fc2f354de5e755fd9f8202357f626e03498fb7ce52a585436d4
...
Source ID: `op-6fb1bf01`
Source Path: `/Users/rk/GolandProjects/wiki/state/sources/github_repo-thumbrise-op-a16ed6ba/checkout/sdk/php/op.php`
Repo Path: `sdk/php/op.php`
Source Class: `first_party`
Language: `php`
Module Name: `sdk/php/op`
Namespace/Package: `Op`
Source Page: [[sources/op-6fb1bf01|op]]

## Summary

op is a php module, defining 4 top-level symbol(s), exporting 4 symbol(s).
...
- `Kind` (enum, exported): enum Kind: string { case String = 'string'; case Integer = 'integer'; case Float = 'float'; case Boolean = 'boolean'; case Binary = 'binary'; case Datetime = 'datetime'; case Ar...
- `Instruction` (class, exported): final class Instruction { /** * @param list<Operation> $operations */ public function __construct( public readonly string $version, public readonly array $operations, ) {} }
- `Operation` (class, exported): final class Operation { /** * @param list<Term> $input * @param list<Term> $output * @param list<Term> $error * @param list<Term> $trait */ public function __construct( public r...
- `Term` (class, exported): final class Term { public function __construct( public readonly string $id, /** Human-readable note about the term. */ public readonly ?string $comment = null, /** Whether this ...
