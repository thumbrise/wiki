---
page_id: 'module:persistencebootloader-778beffd'
kind: module
cssclasses:
  - swarmvault
  - sv-module
title: PersistenceBootloader module
...
project_ids: []
node_ids:
  - 'module:persistencebootloader-778beffd'
  - 'symbol:persistencebootloader-778beffd:persistencebootloader.class'
freshness: fresh
status: active
confidence: 1
created_at: '2026-05-03T05:11:46.054Z'
updated_at: '2026-05-03T05:32:23.265Z'
compiled_from:
  - persistencebootloader-778beffd
managed_by: system
backlinks:
...
source_hashes:
  persistencebootloader-778beffd: 778beffd613180441182f7730a85009bedbece48e9547ac902295ea68013852f
...
language: php
---
# PersistenceBootloader module

Source ID: `persistencebootloader-778beffd`
Source Path: `/Users/rk/GolandProjects/op/poc/spiral-emit/app/src/Application/Bootloader/PersistenceBootloader.php`
Repo Path: `poc/spiral-emit/app/src/Application/Bootloader/PersistenceBootloader.php`
Source Class: `first_party`
Language: `php`
Module Name: `poc/spiral-emit/app/src/Application/Bootloader/PersistenceBootloader`
Namespace/Package: `App\Application\Bootloader`
Source Page: [[sources/persistencebootloader-778beffd|PersistenceBootloader]]

## Summary

PersistenceBootloader is a php module, defining 1 top-level symbol(s), exporting 1 symbol(s), depending on 3 external package import(s).

## Imports

- imports [[code/userrepositoryinterface-4c171a4e|UserRepositoryInterface module]]
- imports [[code/cycleormuserrepository-4728c818|CycleORMUserRepository module]]
...
- `PersistenceBootloader` (class, exported): final class PersistenceBootloader extends Bootloader { protected const SINGLETONS = [ UserRepositoryInterface::class => CycleORMUserRepository::class, ]; }
...
- `PersistenceBootloader` extends `extends Bootloader`
