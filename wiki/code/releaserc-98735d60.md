---
page_id: 'module:releaserc-98735d60'
kind: module
cssclasses:
  - swarmvault
  - sv-module
title: .releaserc module
...
project_ids: []
node_ids:
  - 'module:releaserc-98735d60'
  - 'symbol:releaserc-98735d60:fs.variable'
  - 'symbol:releaserc-98735d60:path.variable'
  - 'symbol:releaserc-98735d60:commitpartial.variable'
freshness: fresh
status: active
confidence: 1
created_at: '2026-05-03T03:56:35.835Z'
updated_at: '2026-05-03T04:02:08.738Z'
compiled_from:
  - releaserc-98735d60
managed_by: system
backlinks:
...
source_hashes:
  releaserc-98735d60: 98735d6072d1dba59979a14562ef3bbe7552289aa47a60048b005e28fa1579c1
...
Source ID: `releaserc-98735d60`
Source Path: `/Users/rk/GolandProjects/wiki/state/sources/github_repo-thumbrise-op-a16ed6ba/checkout/.releaserc.js`
Repo Path: `.releaserc.js`
Source Class: `first_party`
Language: `javascript`
Module Name: `.releaserc`
Source Page: [[sources/releaserc-98735d60|.releaserc]]

## Summary

.releaserc is a javascript module, defining 3 top-level symbol(s), exporting 0 symbol(s).
...
- `fs` (variable): const fs = require('fs');
- `path` (variable): const path = require('path');
- `commitPartial` (variable): const commitPartial = fs.readFileSync( path.join(__dirname, 'release-template.hbs'), 'utf8' );
