---
page_id: 'module:routesbootloader-e4e99d14'
kind: module
cssclasses:
  - swarmvault
  - sv-module
title: RoutesBootloader module
...
project_ids: []
node_ids:
  - 'module:routesbootloader-e4e99d14'
  - 'symbol:routesbootloader-e4e99d14:routesbootloader.class'
freshness: fresh
status: active
confidence: 1
...
backlinks:
  ...
  - 'module:localeselector-a2212b51'
  - 'output:source-briefs/directory-op-597d97ce'
schema_hash: 874431dbbfdec0b254a4aa1bf002900574c9b485735a883690c2becb5f717720
source_hashes:
  routesbootloader-e4e99d14: e4e99d14d7a526ed81b3d68670c65b1f3ad653585d4f65da5f29af1b07b0009d
...
language: php
---
# RoutesBootloader module

Source ID: `routesbootloader-e4e99d14`
Source Path: `/Users/rk/GolandProjects/op/poc/spiral-emit/app/src/Application/Bootloader/RoutesBootloader.php`
Repo Path: `poc/spiral-emit/app/src/Application/Bootloader/RoutesBootloader.php`
Source Class: `first_party`
Language: `php`
Module Name: `poc/spiral-emit/app/src/Application/Bootloader/RoutesBootloader`
Namespace/Package: `App\Application\Bootloader`
Source Page: [[sources/routesbootloader-e4e99d14|RoutesBootloader]]

## Summary

RoutesBootloader is a php module, defining 1 top-level symbol(s), exporting 1 symbol(s), depending on 14 external package import(s).

## Imports

- imports [[code/localeselector-a2212b51|LocaleSelector module]]
- imports `Psr\Http\Message\ResponseInterface`
- imports `Psr\Http\Message\ServerRequestInterface`
- imports `Spiral\Bootloader\Http\RoutesBootloader` (namespace `BaseRoutesBootloader`)
- imports `Spiral\Cookies\Middleware\CookiesMiddleware`
- imports `Spiral\Csrf\Middleware\CsrfMiddleware`
- imports `Spiral\Debug\Middleware\DumperMiddleware`
- imports `Spiral\Debug\StateCollector\HttpCollector`
- imports `Spiral\Filter\ValidationHandlerMiddleware`
- imports `Spiral\Http\Middleware\ErrorHandlerMiddleware`
- imports `Spiral\Http\Middleware\JsonPayloadMiddleware`
- imports `Spiral\Router\Bootloader\AnnotatedRoutesBootloader`
- imports `Spiral\Router\Loader\Configurator\RoutingConfigurator`
- imports `Spiral\Session\Middleware\SessionMiddleware`
...
- `RoutesBootloader` (class, exported): final class RoutesBootloader extends BaseRoutesBootloader { protected const DEPENDENCIES = [AnnotatedRoutesBootloader::class]; #[\Override] protected function globalMiddleware()...

## External Dependencies

- `Psr\Http\Message\ResponseInterface`
- `Psr\Http\Message\ServerRequestInterface`
- `Spiral\Bootloader\Http\RoutesBootloader`
...
- `Spiral\Router\Bootloader\AnnotatedRoutesBootloader`
...
- `RoutesBootloader` extends `extends BaseRoutesBootloader`
