---
page_id: 'module:scitooltip-2260fcf0'
kind: module
cssclasses:
  - swarmvault
  - sv-module
title: SciTooltip module
...
source_hashes:
  scitooltip-2260fcf0: 2260fcf016df57415b031a9f98f183e221b77aec6f107fcdbb19763ad3ac9f32
...
Source ID: `scitooltip-2260fcf0`
Source Path: `/Users/rk/GolandProjects/wiki/state/sources/github_repo-thumbrise-op-a16ed6ba/checkout/docs/.vitepress/components/SciTooltip.vue`
Repo Path: `docs/.vitepress/components/SciTooltip.vue`
Source Class: `first_party`
Language: `vue`
Module Name: `docs/.vitepress/components/SciTooltip`
Source Page: [[sources/scitooltip-2260fcf0|SciTooltip]]

## Summary

SciTooltip is a vue module, defining 13 top-level symbol(s), exporting 3 symbol(s), depending on 1 external package import(s).

## Imports

- imports `vue` (named `nextTick`, `onBeforeUnmount`, `ref`)
...
- `SciTooltip` (class, exported): vue component SciTooltip
- `Teleport` (class, exported): <Teleport to="body">
- `Transition` (class, exported): <Transition name="sci-fade">
- `SciRef` (interface): interface SciRef
- `props` (variable): const props = defineProps<{ title: string body: string refs?: SciRef[] }>()
- `show` (variable): const show = ref(false)
- `trigger` (variable): const trigger = ref<HTMLElement | null>(null)
- `pos` (variable): const pos = ref({top: 0, left: 0})
- `TIP_WIDTH` (variable): const TIP_WIDTH = 280
- `MARGIN` (variable): const MARGIN = 8
- `updatePosition` (function): function updatePosition()
- `onEnter` (function): async function onEnter()
- `onLeave` (function): function onLeave()
