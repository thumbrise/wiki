---
page_id: 'module:session-7a75f197'
kind: module
cssclasses:
  - swarmvault
  - sv-module
...
project_ids: []
node_ids:
  - 'module:session-7a75f197'
freshness: fresh
status: active
confidence: 1
created_at: '2026-05-03T05:11:46.060Z'
...
source_hashes:
  session-7a75f197: 7a75f197ba4557724ef30ef99e0d8fc4dba7fe0bde01326870578a9582bbc654
...
Source ID: `session-7a75f197`
Source Path: `/Users/rk/GolandProjects/op/poc/spiral-emit/app/config/session.php`
Repo Path: `poc/spiral-emit/app/config/session.php`
Source Class: `first_party`
Language: `php`
Module Name: `poc/spiral-emit/app/config/session`
Source Page: [[sources/session-7a75f197|session]]

## Summary

session is a php module, defining 0 top-level symbol(s), exporting 0 symbol(s), depending on 2 external package import(s).

## Imports

- imports `Spiral\Core\Container\Autowire`
- imports `Spiral\Session\Handler\FileHandler`
...
- `Spiral\Session\Handler\FileHandler`
