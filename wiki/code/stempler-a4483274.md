---
page_id: 'module:stempler-a4483274'
kind: module
cssclasses:
  - swarmvault
  - sv-module
title: stempler module
...
project_ids: []
node_ids:
  - 'module:stempler-a4483274'
freshness: fresh
status: active
confidence: 1
created_at: '2026-05-03T05:11:46.061Z'
updated_at: '2026-05-03T05:32:23.277Z'
compiled_from:
  - stempler-a4483274
managed_by: system
backlinks:
...
source_hashes:
  stempler-a4483274: a4483274f10134ab9bca42f5f239a77b1d16a318b207dd0e9d5f4f718b0364e9
...
Source ID: `stempler-a4483274`
Source Path: `/Users/rk/GolandProjects/op/poc/spiral-emit/app/config/views/stempler.php`
Repo Path: `poc/spiral-emit/app/config/views/stempler.php`
Source Class: `first_party`
Language: `php`
Module Name: `poc/spiral-emit/app/config/views/stempler`
Source Page: [[sources/stempler-a4483274|stempler]]

## Summary

stempler is a php module, defining 0 top-level symbol(s), exporting 0 symbol(s), depending on 5 external package import(s).

## Imports

- imports `Spiral\Stempler\Builder`
- imports `Spiral\Stempler\Directive`
- imports `Spiral\Stempler\Transform\Finalizer`
- imports `Spiral\Stempler\Transform\Visitor`
- imports `Spiral\Views\Processor`
...
- `Spiral\Stempler\Builder`
- `Spiral\Stempler\Directive`
- `Spiral\Stempler\Transform\Finalizer`
- `Spiral\Stempler\Transform\Visitor`
- `Spiral\Views\Processor`
