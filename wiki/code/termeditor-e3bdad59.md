---
page_id: 'module:termeditor-e3bdad59'
kind: module
cssclasses:
  - swarmvault
  - sv-module
title: TermEditor module
...
updated_at: '2026-05-03T05:32:23.281Z'
compiled_from:
  - termeditor-e3bdad59
managed_by: system
backlinks:
...
source_hashes:
  termeditor-e3bdad59: e3bdad59d0e20c83835130d2a369289232dc9047e5307759e2521278865776e0
...
Source ID: `termeditor-e3bdad59`
Source Path: `/Users/rk/GolandProjects/wiki/state/sources/github_repo-thumbrise-op-a16ed6ba/checkout/docs/.vitepress/components/TermEditor.vue`
Repo Path: `docs/.vitepress/components/TermEditor.vue`
Source Class: `first_party`
Language: `vue`
Module Name: `docs/.vitepress/components/TermEditor`
Source Page: [[sources/termeditor-e3bdad59|TermEditor]]

## Summary

TermEditor is a vue module, defining 12 top-level symbol(s), exporting 1 symbol(s).
...
- `TermEditor` (class, exported): vue component TermEditor
- `Term` (interface): interface Term
- `toggleRequired` (function): function toggleRequired(term: Term)
- `toggleComment` (function): function toggleComment(term: Term)
- `KINDS` (variable): const KINDS = ['string', 'integer', 'float', 'boolean', 'binary', 'datetime', 'array', 'object', 'enum'] as const
- `COMPOUND` (variable): const COMPOUND = new Set(['object', 'array', 'enum'])
- `NUMERIC` (variable): const NUMERIC = new Set(['integer', 'float'])
- `addTerm` (function): function addTerm(list: Term[])
- `removeTerm` (function): function removeTerm(list: Term[], i: number)
- `onKindChange` (function): function onKindChange(term: Term, raw: string)
- `coerceValue` (function): function coerceValue(raw: string, kind: string | undefined): string | number | boolean
- `onValueInput` (function): function onValueInput(term: Term, raw: string)
...
- `onKindChange` calls `coerceValue`
- `onValueInput` calls `coerceValue`
