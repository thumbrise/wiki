---
page_id: 'module:termviz-37c301d3'
kind: module
cssclasses:
  - swarmvault
  - sv-module
title: TermViz module
...
source_hashes:
  termviz-37c301d3: 37c301d3f6adc4c5ad7274f21bdd15778523dcef5e88eafbcca9cdad0277e839
...
Source ID: `termviz-37c301d3`
Source Path: `/Users/rk/GolandProjects/wiki/state/sources/github_repo-thumbrise-op-a16ed6ba/checkout/docs/.vitepress/components/TermViz.vue`
Repo Path: `docs/.vitepress/components/TermViz.vue`
Source Class: `first_party`
Language: `vue`
Module Name: `docs/.vitepress/components/TermViz`
Source Page: [[sources/termviz-37c301d3|TermViz]]

## Summary

TermViz is a vue module, defining 6 top-level symbol(s), exporting 2 symbol(s).
...
- `TermViz` (class, exported): vue component TermViz
- `SciTooltip` (class, exported): <SciTooltip
- `Term` (interface): interface Term
- `SciRef` (interface): interface SciRef
- `KindMeta` (interface): interface KindMeta
- `kindMeta` (variable): const kindMeta: Record<string, KindMeta> = { string: { face: '🔤 string', title: 'String — Bytes with encoding', body: 'A sequence of characters. At the hardware level — bytes i...
