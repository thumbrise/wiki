---
page_id: 'module:testcase-e8b69b5c'
kind: module
cssclasses:
  - swarmvault
  - sv-module
...
node_ids:
  ...
  - 'symbol:testcase-e8b69b5c:testcase.class'
freshness: fresh
status: active
confidence: 1
created_at: '2026-05-03T05:11:46.063Z'
updated_at: '2026-05-03T05:32:23.282Z'
compiled_from:
  - testcase-e8b69b5c
managed_by: system
backlinks:
  - 'source:testcase-e8b69b5c'
  - 'module:testkernel-a6748afa'
  - 'output:source-briefs/directory-op-597d97ce'
schema_hash: 874431dbbfdec0b254a4aa1bf002900574c9b485735a883690c2becb5f717720
source_hashes:
  testcase-e8b69b5c: e8b69b5cc6823e9618b4642cc3ad3a85d908ea3e7a6da8c26e9659121d19a8db
...
Source ID: `testcase-e8b69b5c`
Source Path: `/Users/rk/GolandProjects/op/poc/spiral-emit/tests/TestCase.php`
Repo Path: `poc/spiral-emit/tests/TestCase.php`
Source Class: `first_party`
Language: `php`
Module Name: `poc/spiral-emit/tests/TestCase`
Namespace/Package: `Tests`
Source Page: [[sources/testcase-e8b69b5c|TestCase]]

## Summary

TestCase is a php module, defining 1 top-level symbol(s), exporting 1 symbol(s), depending on 7 external package import(s).

## Imports

- imports `Spiral\Config\ConfiguratorInterface`
- imports `Spiral\Config\Patch\Set`
- imports `Spiral\Core\Container`
- imports `Spiral\Testing\TestableKernelInterface`
- imports `Spiral\Testing\TestCase` (namespace `BaseTestCase`)
- imports `Spiral\Translator\TranslatorInterface`
- imports [[code/testkernel-a6748afa|TestKernel module]]
...
- `TestCase` (class, exported): class TestCase extends BaseTestCase { public function createAppInstance(Container $container = new Container()): TestableKernelInterface { return TestKernel::create( directories...
...
- `Spiral\Testing\TestableKernelInterface`
- `Spiral\Testing\TestCase`
- `Spiral\Translator\TranslatorInterface`
...
- `TestCase` extends `extends BaseTestCase`
