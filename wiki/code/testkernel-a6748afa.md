---
page_id: 'module:testkernel-a6748afa'
kind: module
cssclasses:
  - swarmvault
  - sv-module
title: TestKernel module
...
node_ids:
  ...
  - 'symbol:testkernel-a6748afa:testkernel.class'
freshness: fresh
status: active
confidence: 1
created_at: '2026-05-03T05:11:46.063Z'
updated_at: '2026-05-03T05:32:23.283Z'
compiled_from:
  - testkernel-a6748afa
managed_by: system
backlinks:
...
source_hashes:
  testkernel-a6748afa: a6748afa7f3fd071868d4d27aa38e55a076326a4b3a678cc490457ee0435773c
...
Source ID: `testkernel-a6748afa`
Source Path: `/Users/rk/GolandProjects/op/poc/spiral-emit/tests/App/TestKernel.php`
Repo Path: `poc/spiral-emit/tests/App/TestKernel.php`
Source Class: `first_party`
Language: `php`
Module Name: `poc/spiral-emit/tests/App/TestKernel`
Namespace/Package: `Tests\App`
Source Page: [[sources/testkernel-a6748afa|TestKernel]]

## Summary

TestKernel is a php module, defining 1 top-level symbol(s), exporting 1 symbol(s), depending on 3 external package import(s).

## Imports

- imports [[code/kernel-a4634d28|Kernel module]]
- imports `Spiral\Testing\TestableKernelInterface`
- imports `Spiral\Testing\Traits\TestableKernel`
...
- `TestKernel` (class, exported): class TestKernel extends Kernel implements TestableKernelInterface { use TestableKernel; }

## External Dependencies

- `Spiral\Testing\TestableKernelInterface`
- `Spiral\Testing\Traits\TestableKernel`
...
- `TestKernel` extends `extends Kernel`
- `TestKernel` implements `implements TestableKernelInterface`
