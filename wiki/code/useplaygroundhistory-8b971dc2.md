---
page_id: 'module:useplaygroundhistory-8b971dc2'
kind: module
cssclasses:
  - swarmvault
  - sv-module
title: usePlaygroundHistory module
...
source_hashes:
  useplaygroundhistory-8b971dc2: 8b971dc240bfe6144ccfd8cd0f202669036c186ae53df000e6d8ce4fffbdd4f3
...
language: typescript
---
# usePlaygroundHistory module

Source ID: `useplaygroundhistory-8b971dc2`
Source Path: `/Users/rk/GolandProjects/wiki/state/sources/github_repo-thumbrise-op-a16ed6ba/checkout/docs/.vitepress/components/playground/usePlaygroundHistory.ts`
Repo Path: `docs/.vitepress/components/playground/usePlaygroundHistory.ts`
Source Class: `first_party`
Language: `typescript`
Module Name: `docs/.vitepress/components/playground/usePlaygroundHistory`
Source Page: [[sources/useplaygroundhistory-8b971dc2|usePlaygroundHistory]]

## Summary

usePlaygroundHistory is a typescript module, defining 4 top-level symbol(s), exporting 2 symbol(s), depending on 1 external package import(s).

## Imports

- imports `vue` (named `computed`, `ref`, `Ref`)
...
- `HistoryState` (interface, exported): export interface HistoryState<T>
- `StoredBuffer` (interface): interface StoredBuffer<T>
- `usePlaygroundHistory` (function, exported): export function usePlaygroundHistory<T>(options: { storageKey: string /** Max snapshots kept. Older entries are dropped FIFO. */ maxEntries?: number /** Debounce for persistence...
- `byteSize` (function): function byteSize(s: string): number
...
- `usePlaygroundHistory` calls `byteSize`
