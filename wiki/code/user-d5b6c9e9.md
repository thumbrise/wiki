...
node_ids:
  ...
  - 'symbol:user-d5b6c9e9:user.class'
freshness: fresh
status: active
confidence: 1
...
source_hashes:
  user-d5b6c9e9: d5b6c9e95dee3bf6eed12c18922cf1f949bfb26f9e0edb75ec54a52a75eea4d4
...
Source ID: `user-d5b6c9e9`
Source Path: `/Users/rk/GolandProjects/op/poc/spiral-emit/app/src/Domain/User/Entity/User.php`
Repo Path: `poc/spiral-emit/app/src/Domain/User/Entity/User.php`
Source Class: `first_party`
Language: `php`
Module Name: `poc/spiral-emit/app/src/Domain/User/Entity/User`
Namespace/Package: `App\Domain\User\Entity`
Source Page: [[sources/user-d5b6c9e9|User]]

## Summary

User is a php module, defining 1 top-level symbol(s), exporting 1 symbol(s), depending on 3 external package import(s).

## Imports

- imports [[code/cycleormuserrepository-4728c818|CycleORMUserRepository module]]
- imports `Cycle\Annotated\Annotation\Column`
- imports `Cycle\Annotated\Annotation\Entity`
...
- `User` (class, exported): #[Entity( repository: CycleORMUserRepository::class, )] class User { /** @psalm-suppress PropertyNotSetInConstructor */ #[Column(type: 'primary')] private int $id; public functi...

## External Dependencies

- `Cycle\Annotated\Annotation\Column`
