---
page_id: 'module:uuidtypecast-bc2c3f4a'
kind: module
cssclasses:
  - swarmvault
  - sv-module
title: UuidTypecast module
...
project_ids: []
node_ids:
  - 'module:uuidtypecast-bc2c3f4a'
  - 'symbol:uuidtypecast-bc2c3f4a:uuidtypecast.class'
freshness: fresh
status: active
confidence: 1
created_at: '2026-05-03T05:11:46.069Z'
...
source_hashes:
  uuidtypecast-bc2c3f4a: bc2c3f4a0ddfbe981993ed39e9ebf17c2e3eed252cb78fec1278a6a7e82064d4
...
Source ID: `uuidtypecast-bc2c3f4a`
Source Path: `/Users/rk/GolandProjects/op/poc/spiral-emit/app/src/Infrastructure/CycleORM/Typecaster/UuidTypecast.php`
Repo Path: `poc/spiral-emit/app/src/Infrastructure/CycleORM/Typecaster/UuidTypecast.php`
Source Class: `first_party`
Language: `php`
Module Name: `poc/spiral-emit/app/src/Infrastructure/CycleORM/Typecaster/UuidTypecast`
Namespace/Package: `App\Infrastructure\CycleORM\Typecaster`
Source Page: [[sources/uuidtypecast-bc2c3f4a|UuidTypecast]]

## Summary

UuidTypecast is a php module, defining 1 top-level symbol(s), exporting 1 symbol(s), depending on 5 external package import(s).

## Imports

- imports `Cycle\Database\DatabaseInterface`
- imports `Cycle\ORM\Parser\CastableInterface`
- imports `Cycle\ORM\Parser\UncastableInterface`
- imports `Ramsey\Uuid\Uuid`
- imports `Ramsey\Uuid\UuidInterface`
...
- `UuidTypecast` (class, exported): final class UuidTypecast implements CastableInterface, UncastableInterface { private array $rules = []; public function __construct( private readonly DatabaseInterface $database...

## External Dependencies

- `Cycle\Database\DatabaseInterface`
...
- `UuidTypecast` implements `implements CastableInterface`
- `UuidTypecast` implements `UncastableInterface`
