---
page_id: 'module:viewrenderer-4600606b'
kind: module
cssclasses:
  - swarmvault
  - sv-module
title: ViewRenderer module
...
node_ids:
  ...
  - 'symbol:viewrenderer-4600606b:viewrenderer.class'
freshness: fresh
status: active
confidence: 1
created_at: '2026-05-03T05:11:46.070Z'
updated_at: '2026-05-03T05:32:23.295Z'
compiled_from:
  - viewrenderer-4600606b
managed_by: system
backlinks:
...
source_hashes:
  viewrenderer-4600606b: 4600606b45ae7437bbbcbff8ceb2ba9f64f17ceb794527127d2cd0e040846bce
...
Source ID: `viewrenderer-4600606b`
Source Path: `/Users/rk/GolandProjects/op/poc/spiral-emit/app/src/Application/Exception/Renderer/ViewRenderer.php`
Repo Path: `poc/spiral-emit/app/src/Application/Exception/Renderer/ViewRenderer.php`
Source Class: `first_party`
Language: `php`
Module Name: `poc/spiral-emit/app/src/Application/Exception/Renderer/ViewRenderer`
Namespace/Package: `App\Application\Exception\Renderer`
Source Page: [[sources/viewrenderer-4600606b|ViewRenderer]]

## Summary

ViewRenderer is a php module, defining 1 top-level symbol(s), exporting 1 symbol(s), depending on 8 external package import(s).

## Imports

- imports `Psr\Http\Message\ResponseFactoryInterface`
- imports `Psr\Http\Message\ResponseInterface`
- imports `Psr\Http\Message\ServerRequestInterface` (namespace `Request`)
- imports `Spiral\Exceptions\Verbosity`
- imports `Spiral\Http\ErrorHandler\RendererInterface`
- imports `Spiral\Http\Header\AcceptHeader`
- imports `Spiral\Views\Exception\ViewException`
- imports `Spiral\Views\ViewsInterface`
...
- `ViewRenderer` (class, exported): final class ViewRenderer implements RendererInterface { private const DEFAULT_VIEW = 'exception/error'; private const VIEW_PATTERN = 'exception/%s'; public function __construct(...
...
- `Spiral\Http\Header\AcceptHeader`
- `Spiral\Views\Exception\ViewException`
- `Spiral\Views\ViewsInterface`
...
- `ViewRenderer` implements `implements RendererInterface`
