---
page_id: 'module:welcome-049f9ac7'
kind: module
cssclasses:
  - swarmvault
  - sv-module
...
project_ids: []
node_ids:
  - 'module:welcome-049f9ac7'
  - 'symbol:welcome-049f9ac7:box.class'
  - 'symbol:welcome-049f9ac7:box-items.class'
  - 'symbol:welcome-049f9ac7:item.class'
  - 'symbol:welcome-049f9ac7:item-title.class'
  - 'symbol:welcome-049f9ac7:item-title-a.class'
  - 'symbol:welcome-049f9ac7:item-title-a-hover.class'
  - 'symbol:welcome-049f9ac7:item-text.class'
  - 'symbol:welcome-049f9ac7:links.class'
  - 'symbol:welcome-049f9ac7:links-item.class'
  - 'symbol:welcome-049f9ac7:links-item-hover.class'
  - 'symbol:welcome-049f9ac7:links-item-not-last-child.class'
  - 'symbol:welcome-049f9ac7:discourse-path-1-discourse-path-2.class'
  - 'symbol:welcome-049f9ac7:discourse-path-3.class'
freshness: fresh
status: active
confidence: 1
created_at: '2026-05-03T05:11:46.074Z'
updated_at: '2026-05-03T05:32:23.302Z'
compiled_from:
  - welcome-049f9ac7
managed_by: system
backlinks:
...
source_hashes:
  welcome-049f9ac7: 049f9ac7089a0ded2393701f10ab22cc3e76b319ae440d685f80396c8e79d671
...
Source ID: `welcome-049f9ac7`
Source Path: `/Users/rk/GolandProjects/op/poc/spiral-emit/public/styles/welcome.css`
Repo Path: `poc/spiral-emit/public/styles/welcome.css`
Source Class: `first_party`
Language: `css`
Module Name: `poc/spiral-emit/public/styles/welcome`
Source Page: [[sources/welcome-049f9ac7|welcome]]

## Summary

welcome is a css module, defining 13 top-level symbol(s), exporting 13 symbol(s).
...
- `.box` (class, exported): .box
- `.box .items` (class, exported): .box .items
- `.item` (class, exported): .item
- `.item__title` (class, exported): .item__title
- `.item__title a` (class, exported): .item__title a
- `.item__title a:hover` (class, exported): .item__title a:hover
- `.item__text` (class, exported): .item__text
- `.links` (class, exported): .links
- `.links-item` (class, exported): .links-item
- `.links-item:hover` (class, exported): .links-item:hover
- `.links-item:not(:last-child)` (class, exported): .links-item:not(:last-child)
- `.discourse-path-1,.discourse-path-2` (class, exported): .discourse-path-1,.discourse-path-2
- `.discourse-path-3` (class, exported): .discourse-path-3
