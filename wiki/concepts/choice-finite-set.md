---
page_id: 'concept:choice-finite-set'
kind: concept
cssclasses:
  - swarmvault
  - sv-concept
title: Choice (Finite Set)
...
A limited, discrete set of possible states or values (e.g., a traffic light being red, yellow, or green).
