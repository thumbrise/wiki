---
page_id: 'concept:continuous-integration-ci'
kind: concept
cssclasses:
  - swarmvault
  - sv-concept
...
The process and methodology of merging code changes frequently into a shared repository, often automated by a workflow.
