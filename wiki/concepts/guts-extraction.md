---
page_id: 'concept:guts-extraction'
kind: concept
cssclasses:
  - swarmvault
  - sv-concept
title: Guts-extraction
...
The current transitional phase of tooling where instructions must be extracted retroactively by parsing frameworks or scraping routers, necessary due to programs not intrinsically knowing their own operations.
