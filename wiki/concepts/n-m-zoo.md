...
The present state where programs are overly duplicated (1400 times), written once per vendor and once per consumer, leading the industry to focus energy on 'glue' rather than core functionality.
