...
A category defining the underlying type or nature of data (e.g., integer, string, object). The 'kind' is the fact; the language's implementation is the projection.
