---
page_id: 'source:chunk-7oikw5wk-a144e02d'
kind: source
cssclasses:
  - swarmvault
  - sv-source
title: chunk-7OIKW5WK
...
updated_at: '2026-05-03T05:32:23.188Z'
compiled_from:
  - chunk-7oikw5wk-a144e02d
managed_by: system
backlinks:
...
- Language: `javascript`
- Module Page: [[code/chunk-7oikw5wk-a144e02d|chunk-7OIKW5WK module]]
- Exports: camelize, capitalize, toHandlerKey, normalizeStyle, normalizeClass, normalizeProps, toDisplayString, EffectScope, effectScope, getCurrentScope, onScopeDispose, ReactiveEffect, effect, stop, reactive, shallowReactive, readonly, shallowReadonly, isReactive, isReadonly, isShallow, isProxy, toRaw, markRaw, isRef2 as isRef, ref, shallowRef, triggerRef, unref, toValue, proxyRefs, customRef, toRefs, toRef, TrackOpTypes, TriggerOpTypes, getCurrentWatcher, onWatcherCleanup, assertNumber, ErrorCodes, callWithErrorHandling, callWithAsyncErrorHandling, handleError, nextTick, queuePostFlushCb, pushScopeId, popScopeId, withScopeId, withCtx, withDirectives, provide, inject, hasInjectionContext, ssrContextKey, useSSRContext, watchEffect, watchPostEffect, watchSyncEffect, watch2 as watch, Teleport, useTransitionState, BaseTransitionPropsValidators, BaseTransition, resolveTransitionHooks, setTransitionHooks, getTransitionRawChildren, defineComponent, useId, useTemplateRef, hydrateOnIdle, hydrateOnVisible, hydrateOnMediaQuery, hydrateOnInteraction, defineAsyncComponent, KeepAlive, onActivated, onDeactivated, onBeforeMount, onMounted, onBeforeUpdate, onUpdated, onBeforeUnmount, onUnmounted, onServerPrefetch, onRenderTriggered, onRenderTracked, onErrorCaptured, resolveComponent, resolveDynamicComponent, resolveDirective, renderList, createSlots, renderSlot, toHandlers, defineProps, defineEmits, defineExpose, defineOptions, defineSlots, defineModel, withDefaults, useSlots, useAttrs, mergeDefaults, mergeModels, createPropsRestProxy, withAsyncContext, useModel, createRenderer, createHydrationRenderer, Suspense, Fragment, Text, Comment, Static, openBlock, setBlockTracking, createElementBlock, createBlock, isVNode, transformVNodeArgs, createBaseVNode, createVNode, guardReactiveProps, cloneVNode, createTextVNode, createStaticVNode, createCommentVNode, mergeProps, getCurrentInstance, registerRuntimeCompiler, isRuntimeOnly, computed2 as computed, h, initCustomFormatter, withMemo, isMemoSame, version, warn2 as warn, ErrorTypeStrings, devtools, setDevtoolsHook, ssrUtils, resolveFilter, compatUtils, DeprecationTypes, nodeOps, Transition, vShow, useCssVars, patchProp, defineCustomElement, defineSSRCustomElement, VueElement, useHost, useShadowRoot, useCssModule, TransitionGroup, vModelText, vModelCheckbox, vModelRadio, vModelSelect, vModelDynamic, withModifiers, withKeys, render, hydrate, createApp, createSSRApp, initDirectivesForSSR, compile2 as compile
- Symbols: makeMap, EMPTY_OBJ, EMPTY_ARR, NOOP, NO, isOn, isModelListener, extend, remove, hasOwnProperty, hasOwn, isArray, isMap, isSet, isDate, isRegExp, isFunction, isString, isSymbol, isObject, isPromise, objectToString, toTypeString, toRawType, isPlainObject, isIntegerKey, isReservedProp, isBuiltInDirective, cacheStringFunction, camelizeRE, camelize, hyphenateRE, hyphenate, capitalize, toHandlerKey, hasChanged, invokeArrayFns, def, looseToNumber, toNumber, _globalThis, getGlobalThis, GLOBALS_ALLOWED, isGloballyAllowed, normalizeStyle, listDelimiterRE, propertyDelimiterRE, styleCommentRE, parseStringStyle, stringifyStyle, normalizeClass, normalizeProps, HTML_TAGS, SVG_TAGS, MATH_TAGS, VOID_TAGS, isHTMLTag, isSVGTag, isMathMLTag, isVoidTag, specialBooleanAttrs, isSpecialBooleanAttr, isBooleanAttr, includeBooleanAttr, isKnownHtmlAttr, isKnownSvgAttr, isKnownMathMLAttr, isRenderableAttrValue, cssVarNameEscapeSymbolsRE, getEscapedCssVarName, looseCompareArrays, looseEqual, looseIndexOf, isRef, toDisplayString, replacer, stringifySymbol, normalizeCssVarValue, warn, activeEffectScope, EffectScope, effectScope, getCurrentScope, onScopeDispose, activeSub, pausedQueueEffects, ReactiveEffect, batchDepth, batchedSub, batchedComputed, batch, startBatch, endBatch, prepareDeps, cleanupDeps, isDirty, refreshComputed, removeSub, removeDep, effect, stop, shouldTrack, trackStack, pauseTracking, resetTracking, cleanupEffect, globalVersion, Link, Dep, addSub, targetMap, ITERATE_KEY, MAP_KEY_ITERATE_KEY, ARRAY_ITERATE_KEY, track, trigger, getDepFromReactive, reactiveReadArray, shallowReadArray, toWrapped, arrayInstrumentations, iterator, arrayProto, apply, reduce, searchProxy, noTracking, isNonTrackableKeys, builtInSymbols, hasOwnProperty2, BaseReactiveHandler, MutableReactiveHandler, ReadonlyReactiveHandler, mutableHandlers, readonlyHandlers, shallowReactiveHandlers, shallowReadonlyHandlers, toShallow, getProto, createIterableMethod, createReadonlyMethod, createInstrumentations, createInstrumentationGetter, mutableCollectionHandlers, shallowCollectionHandlers, readonlyCollectionHandlers, shallowReadonlyCollectionHandlers, checkIdentityKeys, reactiveMap, shallowReactiveMap, readonlyMap, shallowReadonlyMap, targetTypeMap, getTargetType, reactive, shallowReactive, readonly, shallowReadonly, createReactiveObject, isReactive, isReadonly, isShallow, isProxy, toRaw, markRaw, toReactive, toReadonly, isRef2, ref, shallowRef, createRef, RefImpl, triggerRef, unref, toValue, shallowUnwrapHandlers, proxyRefs, CustomRefImpl, customRef, toRefs, ObjectRefImpl, GetterRefImpl, toRef, propertyToRef, ComputedRefImpl, computed, TrackOpTypes, TriggerOpTypes, INITIAL_WATCHER_VALUE, cleanupMap, activeWatcher, getCurrentWatcher, onWatcherCleanup, watch, traverse, stack, pushWarningContext, popWarningContext, isWarning, warn$1, getComponentTrace, formatTrace, formatTraceEntry, formatProps, formatProp, assertNumber, ErrorCodes, ErrorTypeStrings$1, callWithErrorHandling, callWithAsyncErrorHandling, handleError, logError, queue, flushIndex, pendingPostFlushCbs, activePostFlushCbs, postFlushIndex, resolvedPromise, currentFlushPromise, RECURSION_LIMIT, nextTick, findInsertionIndex, queueJob, queueFlush, queuePostFlushCb, flushPreFlushCbs, flushPostFlushCbs, getId, flushJobs, checkRecursiveUpdates, isHmrUpdating, setHmrUpdating, hmrDirtyComponents, map, registerHMR, unregisterHMR, createRecord, normalizeClassComponent, rerender, reload, updateComponentDef, tryWrap, devtools$1, buffer, devtoolsNotInstalled, emit$1, setDevtoolsHook$1, devtoolsInitApp, devtoolsUnmountApp, devtoolsComponentAdded, devtoolsComponentUpdated, _devtoolsComponentRemoved, devtoolsComponentRemoved, createDevtoolsComponentHook, devtoolsPerfStart, devtoolsPerfEnd, createDevtoolsPerformanceHook, devtoolsComponentEmit, currentRenderingInstance, currentScopeId, setCurrentRenderingInstance, pushScopeId, popScopeId, withScopeId, withCtx, validateDirectiveName, withDirectives, invokeDirectiveHook, provide, inject, hasInjectionContext, ssrContextKey, useSSRContext, watchEffect, watchPostEffect, watchSyncEffect, watch2, doWatch, instanceWatch, createPathGetter, TeleportEndKey, isTeleport, isTeleportDisabled, isTeleportDeferred, isTargetSVG, isTargetMathML, resolveTarget, TeleportImpl, moveTeleport, hydrateTeleport, Teleport, updateCssVars, prepareAnchor, leaveCbKey, enterCbKey, useTransitionState, TransitionHookValidator, BaseTransitionPropsValidators, recursiveGetSubtree, BaseTransitionImpl, findNonCommentChild, BaseTransition, getLeavingNodesForType, resolveTransitionHooks, emptyPlaceholder, getInnerChild$1, setTransitionHooks, getTransitionRawChildren, defineComponent, useId, markAsyncBoundary, knownTemplateRefs, useTemplateRef, isTemplateRefKey, pendingSetRefMap, setRef, invalidatePendingSetRef, hasLoggedMismatchError, logMismatchError, isSVGContainer, isMathMLContainer, getContainerType, isComment, createHydrationFunctions, propHasMismatch, toClassSet, isSetEqual, toStyleMap, isMapEqual, resolveCssVars, allowMismatchAttr, MismatchTypeString, isMismatchAllowed, requestIdleCallback, cancelIdleCallback, hydrateOnIdle, elementIsVisibleInViewport, hydrateOnVisible, hydrateOnMediaQuery, hydrateOnInteraction, forEachElement, isAsyncWrapper, defineAsyncComponent, createInnerComp, isKeepAlive, KeepAliveImpl, KeepAlive, matches, onActivated, onDeactivated, registerKeepAliveHook, injectToKeepAliveRoot, resetShapeFlag, getInnerChild, injectHook, createHook, onBeforeMount, onMounted, onBeforeUpdate, onUpdated, onBeforeUnmount, onUnmounted, onServerPrefetch, onRenderTriggered, onRenderTracked, onErrorCaptured, COMPONENTS, DIRECTIVES, resolveComponent, NULL_DYNAMIC_COMPONENT, resolveDynamicComponent, resolveDirective, resolveAsset, resolve, renderList, createSlots, renderSlot, ensureValidVNode, toHandlers, getPublicInstance, publicPropertiesMap, isReservedPrefix, hasSetupBinding, PublicInstanceProxyHandlers, RuntimeCompiledPublicInstanceProxyHandlers, createDevRenderContext, exposePropsOnRenderContext, exposeSetupStateOnRenderContext, warnRuntimeUsage, defineProps, defineEmits, defineExpose, defineOptions, defineSlots, defineModel, withDefaults, useSlots, useAttrs, getContext, normalizePropsOrEmits, mergeDefaults, mergeModels, createPropsRestProxy, withAsyncContext, createDuplicateChecker, shouldCacheAccess, applyOptions, resolveInjections, callHook, createWatcher, resolveMergedOptions, mergeOptions, internalOptionMergeStrats, mergeDataFn, mergeInject, normalizeInject, mergeAsArray, mergeObjectOptions, mergeEmitsOrPropsOptions, mergeWatchOptions, createAppContext, uid$1, createAppAPI, currentApp, useModel, getModelModifiers, emit, mixinEmitsCache, normalizeEmitsOptions, isEmitListener, accessedAttrs, markAttrsAccessed, renderComponentRoot, getChildRoot, filterSingleRoot, getFunctionalFallthrough, filterModelListeners, isElementRoot, shouldUpdateComponent, hasPropsChanged, hasPropValueChanged, updateHOCHostEl, internalObjectProto, createInternalObject, isInternalObject, initProps, isInHmrContext, updateProps, setFullProps, resolvePropValue, mixinPropsCache, normalizePropsOptions, validatePropName, getType, validateProps, validateProp, isSimpleType, assertType, getInvalidTypeMessage, styleValue, isExplicable, isBoolean, isInternalKey, normalizeSlotValue, normalizeSlot, normalizeObjectSlots, normalizeVNodeSlots, assignSlots, initSlots, updateSlots, supported, perf, startMeasure, endMeasure, isSupported, initFeatureFlags, queuePostRenderEffect, createRenderer, createHydrationRenderer, baseCreateRenderer, resolveChildrenNamespace, toggleRecurse, needTransition, traverseStaticChildren, getSequence, locateNonHydratedAsyncRoot, invalidateMount, resolveAsyncComponentPlaceholder, isSuspense, suspenseId, SuspenseImpl, Suspense, triggerEvent, mountSuspense, patchSuspense, hasWarned, createSuspenseBoundary, hydrateSuspense, normalizeSuspenseChildren, normalizeSuspenseSlot, queueEffectWithSuspense, setActiveBranch, isVNodeSuspensible, Fragment, Text, Comment, Static, blockStack, currentBlock, openBlock, closeBlock, isBlockTreeEnabled, setBlockTracking, setupBlock, createElementBlock, createBlock, isVNode, isSameVNodeType, vnodeArgsTransformer, transformVNodeArgs, createVNodeWithArgsTransform, normalizeKey, normalizeRef, createBaseVNode, createVNode, _createVNode, guardReactiveProps, cloneVNode, deepCloneVNode, createTextVNode, createStaticVNode, createCommentVNode, normalizeVNode, cloneIfMounted, normalizeChildren, mergeProps, invokeVNodeHook, emptyAppContext, uid, createComponentInstance, currentInstance, getCurrentInstance, internalSetCurrentInstance, setInSSRSetupState, setCurrentInstance, unsetCurrentInstance, isBuiltInTag, validateComponentName, isStatefulComponent, isInSSRComponentSetup, setupComponent, setupStatefulComponent, handleSetupResult, compile, installWithProxy, registerRuntimeCompiler, isRuntimeOnly, finishComponentSetup, attrsProxyHandlers, getSlotsProxy, createSetupContext, getComponentPublicInstance, classifyRE, classify, getComponentName, formatComponentName, isClassComponent, computed2, h, initCustomFormatter, withMemo, isMemoSame, version, warn2, ErrorTypeStrings, devtools, setDevtoolsHook, _ssrUtils, ssrUtils, resolveFilter, compatUtils, DeprecationTypes, policy, tt, unsafeToTrustedHTML, svgNS, mathmlNS, doc, templateContainer, nodeOps, TRANSITION, ANIMATION, vtcKey, DOMTransitionPropsValidators, TransitionPropsValidators, decorate$1, Transition, callHook2, hasExplicitCallback, resolveTransitionProps, normalizeDuration, NumberOf, addTransitionClass, removeTransitionClass, nextFrame, endId, whenTransitionEnds, getTransitionInfo, getTimeout, toMs, forceReflow, patchClass, vShowOriginalDisplay, vShowHidden, vShow, setDisplay, initVShowForSSR, CSS_VAR_TEXT, useCssVars, setVarsOnVNode, setVarsOnNode, displayRE, patchStyle, semicolonRE, importantRE, setStyle, prefixes, prefixCache, autoPrefix, xlinkNS, patchAttr, patchDOMProp, addEventListener, removeEventListener, veiKey, patchEvent, optionsModifierRE, parseName, cachedNow, p, getNow, createInvoker, sanitizeEventValue, patchStopImmediatePropagation, isNativeOn, patchProp, shouldSetAsProp, shouldSetAsPropForVueCE, REMOVAL, defineCustomElement, defineSSRCustomElement, BaseClass, VueElement, useHost, useShadowRoot, useCssModule, positionMap, newPositionMap, moveCbKey, enterCbKey2, decorate, TransitionGroupImpl, TransitionGroup, callPendingCbs, recordPosition, applyTranslation, getPosition, hasCSSTransform, getModelAssigner, onCompositionStart, onCompositionEnd, assignKey, castValue, vModelText, vModelCheckbox, setChecked, vModelRadio, vModelSelect, setSelected, getValue, getCheckboxValue, vModelDynamic, resolveDynamicModel, callModelHook, initVModelForSSR, systemModifiers, modifierGuards, withModifiers, keyNames, withKeys, rendererOptions, renderer, enabledHydration, ensureRenderer, ensureHydrationRenderer, render, hydrate, createApp, createSSRApp, resolveRootNamespace, injectNativeTagCheck, injectCompilerOptionsCheck, normalizeContainer, ssrDirectiveInitialized, initDirectivesForSSR, initDev, compile2
- Diagnostics: None.
...
- chunk-7OIKW5WK exports camelize, capitalize, toHandlerKey, normalizeStyle, and more. [source:chunk-7oikw5wk-a144e02d]
- chunk-7OIKW5WK defines makeMap, EMPTY_OBJ, EMPTY_ARR, NOOP, NO, and more. [source:chunk-7oikw5wk-a144e02d]

## Questions

- Which downstream pages should explain how chunk-7OIKW5WK exports are consumed?
- What broader responsibility does chunk-7OIKW5WK serve in the codebase?
