---
page_id: 'source:playground-e45a65a6'
kind: source
cssclasses:
  - swarmvault
  - sv-source
...
- Language: `vue`
- Module Page: [[code/playground-e45a65a6|Playground module]]
- Exports: Playground, TermEditor, JsonEditor, SciTooltip, TermViz
- Symbols: Playground, TermEditor, JsonEditor, SciTooltip, TermViz, Snapshot, history, normalizeTerm, normalizeOperation, seed, operations, activeIndex, applyingSnapshot, applySnapshot, onUndo, onRedo, clearAll, loadTutorial, now, nowTimer, saveAck, isEditableTarget, onKeydown, savedLabel, bufferLabel, op, addOperation, removeOperation, json, showJson, leftPanel, jsonErrors, jsonDraft, copyJson, resetJson, onJsonEdit, expandedTraits, toggleTrait, confirmRemove
- Diagnostics: None.
...
- Playground exports Playground, TermEditor, JsonEditor, SciTooltip, and more. [source:playground-e45a65a6]
- Playground defines Playground, TermEditor, JsonEditor, SciTooltip, TermViz, and more. [source:playground-e45a65a6]
- Playground imports vue, ./playground/JsonEditor.vue, ./playground/jsonValidation, ./playground/usePlaygroundHistory, and more. [source:playground-e45a65a6]

## Questions

- Which downstream pages should explain how Playground exports are consumed?
- How does Playground coordinate with its imported local modules?
- Why does Playground depend on vue?
- What broader responsibility does Playground serve in the codebase?
